...
#create_clock -period 80.000 -name sys_clk_pin -waveform {0.000 40.000} -add [get_ports clk]

set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets cro/slice_one/m2]
